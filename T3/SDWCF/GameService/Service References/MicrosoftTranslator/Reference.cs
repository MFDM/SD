...
namespace GameService.MicrosoftTranslator {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private GameService.MicrosoftTranslator.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public GameService.MicrosoftTranslator.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        GameService.MicrosoftTranslator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, GameService.MicrosoftTranslator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, GameService.MicrosoftTranslator.Translation[] translations, string from, string to, GameService.MicrosoftTranslator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        GameService.MicrosoftTranslator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, GameService.MicrosoftTranslator.TranslateOptions options);
        ...
        GameService.MicrosoftTranslator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, GameService.MicrosoftTranslator.TranslateOptions options);
        ...
        GameService.MicrosoftTranslator.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, GameService.MicrosoftTranslator.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : GameService.MicrosoftTranslator.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<GameService.MicrosoftTranslator.LanguageService>, GameService.MicrosoftTranslator.LanguageService {
        ...
        public GameService.MicrosoftTranslator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, GameService.MicrosoftTranslator.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, GameService.MicrosoftTranslator.Translation[] translations, string from, string to, GameService.MicrosoftTranslator.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public GameService.MicrosoftTranslator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, GameService.MicrosoftTranslator.TranslateOptions options) {
        ...
        public GameService.MicrosoftTranslator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, GameService.MicrosoftTranslator.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public GameService.MicrosoftTranslator.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, GameService.MicrosoftTranslator.TranslateOptions options) {
